  ...
  return (
    ...
    <Header />
     <div className="py-10 px-4 md:px-10">
      ...
      <p className="text-center text-white mt-2">Explore our features designed for a seamless experience and powerful functionality</p>
      


    <div className="grid grid-cols-1 md:grid-cols-1 gap-6 py-6 text-white">
    <div className="p-6 border border-purple-800 rounded-lg bg-gray-900 transition duration-300 hover:border-purple-600 hover:scale-105 hover:shadow-lg hover:shadow-purple-600/50">
