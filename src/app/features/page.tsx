...
const Features = () => {
  return (
    ...
    <div className="p-6 border border-purple-800 rounded-lg  transition duration-300 hover:border-purple-600 hover:scale-105 hover:shadow-lg hover:shadow-purple-600/50">
